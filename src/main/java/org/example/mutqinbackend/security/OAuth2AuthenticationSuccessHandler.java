    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        try {
            ...
            if ("login".equals(action) && !oAuth2Service.emailExists(email)) {
                String errorUrl = UriComponentsBuilder.fromUriString("http://localhost:5173/login/error")
            ...
            String tempURL = "http://localhost:5173/login/success";// temp till front integration
